...
var theClosest = 'THE CLOSEST!!! JUST THINK LEET AND YOULL GET IT!! NEWB CAKE!'
var numberTries = 0;
...
var scaredTries = 0;
 while(scaredTries < 6) {
   ...
   if(scaredPrompt.toLowerCase() === 'clowns' || scaredPrompt.toLowerCase() ===  'clown' || scaredPrompt.toLowerCase() ===  'the dark' || scaredPrompt.toLowerCase() ===  'darkness' || scaredPrompt.toLowerCase() ===  'bees') {
